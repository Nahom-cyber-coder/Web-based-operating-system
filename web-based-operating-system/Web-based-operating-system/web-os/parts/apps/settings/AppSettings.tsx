...
import { Package, Trash2, Download, AlertTriangle, Star, RotateCcw, Search } from 'lucide-react';
...
<h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">App Management</h3>

<div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
<div className="p-4 border-b border-gray-200 dark:border-gray-700">
<div className="flex items-center justify-between mb-4">
<h4 className="text-lg font-semibold text-gray-900 dark:text-white">Installed Applications</h4>
...
<div>
<span className="font-medium text-gray-900 dark:text-white">Total Applications:</span>
